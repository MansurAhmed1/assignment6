  ...
  function searchButton(){
   ...
   if(inputFieldValue==''){
    ...
    .then(data=>{
      ...
      document.getElementById('show-all').innerHTML=`<button  class="btn text-white border border-white px-5 d-block mx-auto my-4  " onclick="showall()" >showall</button>`
...
console.log(data.others)
     ...
     <div class="row g-0">
       ...
       <div class="text-end d-block d-lg-none"><span onclick="deleteFunction(this)"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" style="margin-right:10px; margin-top:10px;color:black;" fill="currentColor" class="bi bi-x-square bg-danger text-white rounded-circle" viewBox="0 0 16 16">
